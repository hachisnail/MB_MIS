...
export const sendEmailNotification = async (req, res) => {
  try {
    const { recipientEmail, subject, message, status, appointmentDetails, feedbackLink } = req.body;
