const ArtifactDetailsShells = ({ left, middle, right, className = "" }) => {
  return (
    <div
      className={`w-full h-full rounded-md grid grid-cols-[43rem_1fr_60rem] ${className}`}
    >
      <section className="col-span-1 w-full h-full bg-black relative overflow-visible flex flex-col">
        {left}
      </section>

      <section className="col-span-1 w-full h-full flex flex-col overflow-y-auto pr-6">
        {middle}
      </section>
