    ...
    <div className="w-full h-full flex">
      ...
      {activeTab === "left" && (
        <div className="flex gap-x-10 w-full h-full">
          <div className="min-w-[60rem] h-full flex flex-col gap-y-10">
            <div className="w-full min-h-fit h-fit border gap-y-6 border-gray-400 rounded-lg flex flex-col p-8">
      ...
      {activeTab === "right" && (
        <div className="w-full flex h-full gap-x-10">
          ...
          <form className="min-w-[60rem] h-full rounded-lg bg-gray-200 flex flex-col px-10 pt-15 pb-10">
