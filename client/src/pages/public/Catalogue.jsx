  ...
  return (
    <div className="w-screen min-w-fit pt-40  items-center min-h-screen flex flex-col">
      ...
      <div className="w-[84vw] mt-40 space-y-10 h-fit flex flex-col">
        ...
        <div className="flex mt-20 items-center space-x-4 mb-4">
          <button
            onClick={() => handleTabClick("latest")}
            className={`
            text-2xl text-white font-semibold cursor-pointer focus:outline-none
            ${activeTab === "latest" ? "underline underline-offset-8" : ""}
          `}
          >
            Latest
          </button>
          ...
          <button
            onClick={() => handleTabClick("temporary")}
            className={`
            text-2xl text-white font-semibold cursor-pointer focus:outline-none
            ${activeTab === "temporary" ? "underline underline-offset-8" : ""}
          `}
          >
            Temporary
          </button>
